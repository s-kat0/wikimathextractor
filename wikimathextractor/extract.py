...
def clean(extractor, text, expand_templates=False, html_safe=True):
    ...
    def replace_math(text, placeholder_math_tag, index, formulas):
        ...
        for match in pattern.finditer(text):
            ...
            index += 1
        return text, index, formulas

    text, math_index, formulas_all = replace_math(
        text, placeholder_math_tag, math_index, formulas_all
    )
    ...
    # Collect math contents again for cases they are generated by templates
    text, math_index, formulas_all = replace_math(
        text, placeholder_math_tag, math_index, formulas_all
    )
